...
public class ClimbWithRateOfClimbPanel extends ProcedureSpecificDialogManager implements ActionListener{
	...
	public ClimbWithRateOfClimbPanel(JFrame parent, String title){
	super(parent, title, false); 
    setLocation(2, 400);

     m_parent_panel = new JPanel();
     m_altitude_panel = new AltitudePanel();
     m_altitude_panel.set_keep_sel_alt_above_target_alt();
     m_speed_panel = SpeedPanel.getInstance();
     m_vs_panel = new VSPanel();
     m_vs_panel.set_vs_climb_only();
